...
/////////////////////////////////////////////////////////////////////////////////////////////////////////// */
 $(document).ready(function(){
	...
	$("#nav .menu_3depth>a").click(function(){
		...
		// 메뉴 배경 사이즈 갱신
		$(this).parents("ul").siblings("a").trigger('mouseover');
	});
...
//$(function () {
	...
	//$(".box01").mouseover(function () {
		//$(".box01").css("background", "url(/static/web/2020/img/2019/bg_m_visual_i01.png) no-repeat right bottom");
	//});
...
$(function () {
	...
	$(".box02").mouseover(function () {
		$(".box01").css("background", "none");
		$(".box01").css("border", "6px solid #017dc7");		
		$(".box02").css("background", "url(/static/web/2020/img/2019/bg_m_visual_i02.png) no-repeat right bottom");
	...
	$(".box03").mouseover(function () {
		...
		$(".box02").css("background", "none");
		$(".box02").css("border", "6px solid #017dc7");;
		$(".box03").css("background", "url(/static/web/2020/img/2019/bg_m_visual_i03.png) no-repeat right bottom");
