...
/* eslint-disable */
/* global-module */
import detector from '/static/web/js/detector.js';
import usebOCRWASMParser from '/static/web/js/useb-ocr-wasm-parser.js?12351';
import usebOCRAPIParser from '/static/web/js/useb-ocr-api-parser.js';
import { isSupportWasm, measure, simd, threads } from '/static/web/js/wasm-feature-detect.js';
import ImageUtil from '/static/web/js/image-util.js';
var instance;
class UseBOCR {
  /** public properties */
    ...
    return _asyncToGenerator(function* () {
      try {
        ...
        if (video) {
          ...
          //video.webkitExitFullscreen(); -> 크롬(v125)에서 인식 이슈로 주석
        } else {
  ...
  __setupDomElements() {
    ...
    return _asyncToGenerator(function* () {
      ...
      var mask_frame = _this18.__options.maskFrameStyle.base_color + 'CC';
      if (!!_this18.__options.showClipFrame) {
        mask_frame = _this18.__options.maskFrameStyle.clip_frame + 'CC';
      }
