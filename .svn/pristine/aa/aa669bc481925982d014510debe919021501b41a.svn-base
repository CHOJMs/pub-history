...
(function(root, factory) {
    ...
    self.selectors.forEach(function(el) {
      ...
      context.checkCaption =  function(exportButton) {
		if(settings.div != null){
			el = document.getElementById(settings.div);
  ...
  TableExport.prototype = {
    ...
    defaults: {
	  ...
	  div: null,
	  xlsxButtonContent: "Export to xlsx",
	  xlsmButtonContent: "Export to xlsm",
	  xlsbButtonContent: "Export to xlsb",
	  xlsButtonContent: "Export to xls",
	  csvButtonContent: "Export to csv",
	  txtmButtonContent: "Export to txt"
	},
    /**
     * Constants
     * @memberof TableExport.prototype
    ...
    exporters: {
      build: function(context, key) {
        ...
        settings.exportButtons &&
          context.checkCaption(self.createObjButton(hashKey, dataObject, eval("settings."+key+"ButtonContent"), format.defaultClass, settings.bootstrapSettings));
