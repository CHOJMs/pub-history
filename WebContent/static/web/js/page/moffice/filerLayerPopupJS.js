...
var __FILER_FILES_NAME = "__filerFilesName";            // 전송할 file 정보를 가지고있는 GLOBAL NAME ex) window[__FILER_FILES_NAME]
...
//                  feedback: "업로드할 파일을 추가해주세요.",
                    feedback: function(t) {
                        ...
                        $layer.find(".jFiler-input-caption").html("업로드할 파일을 추가해주세요.");
...
//          console.log(files);
            window[__FILER_FILES_NAME] = filerApi.getInputEl().attr("name");
