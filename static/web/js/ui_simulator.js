...
class UISimulator {
  ...
  __bindEventListener() {
    window.onload = () => {
	  ...
	  this.__settings.useTopUI = true;
	  this.__settings.useMiddleUI = true;
	  this.__settings.useBottomUI = true;
	  this.__settings.usePreviewUI = true;
	  this.__settings.useTopUITextMsg = true;
	  this.__settings.useMiddleUITextMsg = false;
	  this.__settings.useBottomUITextMsg = false;

	  this.__settings.useMaskFrameColorChange = false;
	 // this.__settings.maskFrameStyle = "#33333300";
	  this.__settings.calcGuideBoxCriteria = 'ocrViewSize';
